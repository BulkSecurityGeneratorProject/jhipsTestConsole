...
public class JhipsTestConsoleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsTestConsoleApp.class);

    private final Environment env;

    public JhipsTestConsoleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsTestConsole.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsTestConsoleApp.class);
